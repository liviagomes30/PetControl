...
public class MedicacaoModel {
    ...
    public MedicacaoModel(Integer idmedicacao, Integer idanimal, Integer idhistorico,
                          Integer posologia_medicamento_idproduto,
                          Integer posologia_receitamedicamento_idreceita, LocalDate data) {
    ...
    public MedicacaoModel(Integer idanimal, Integer idhistorico,
                          Integer posologia_medicamento_idproduto,
                          Integer posologia_receitamedicamento_idreceita, LocalDate data) {
        this.idanimal = idanimal;
        this.idhistorico = idhistorico;
