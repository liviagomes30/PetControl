...
public class AnimalController {
    ...
    public ResponseEntity<List<AnimalModel>> listarAnimais() {
        List<AnimalModel> animais = animalService.listarAnimais(); // 'animalService' é o backend AnimalService
        if (animais == null || animais.isEmpty()) { // Adicionei checagem de null para segurança
